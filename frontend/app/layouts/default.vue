    ...
    <header class="header">
      <div class="header-left">
        <button class="brand" @click="navigateTo('/')">
          <div class="brand-mark">
            <img v-if="showBrandImage" :src="brandLogo" :alt="t('layouts.default.brandName')" class="brand-logo" @error="showBrandImage = false" />
            <span v-else class="brand-fallback">{{ t('layouts.default.brandMark') }}</span>
          </div>
          <div class="brand-text">
            <span class="brand-name">{{ t('layouts.default.brandName') }}</span>
            <span class="brand-sub">{{ t('layouts.default.brandSub') }}</span>
          </div>
        </button>
      </div>
      ...
      <nav class="header-nav">
        <NuxtLink to="/" class="nav-link" :class="{ active: route.path === '/' }">
          ...
          <span>{{ t('layouts.default.navProjects') }}</span>
        </NuxtLink>
        <NuxtLink to="/settings" class="nav-link" :class="{ active: route.path === '/settings' }">
          ...
          <span>{{ t('layouts.default.navSettings') }}</span>
        </NuxtLink>
      </nav>
